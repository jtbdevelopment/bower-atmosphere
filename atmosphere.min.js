...
}}(this,function(){var c="2.2.10-javascript",a={},e,d=false,h=[],g=[],f=0,b=Object.prototype.hasOwnProperty;
...
if(a.util.browser.mozilla){a.util.debug(new Date()+" Atmosphere: beforeunload event: Firefox detected. Calling unsubscribe.");
a.unsubscribe()
}});
